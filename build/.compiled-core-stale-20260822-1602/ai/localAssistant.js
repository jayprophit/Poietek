...
exports.runLocalStudioAssistant = runLocalStudioAssistant;
function finding(id, title, detail, category, evidence, proposedAction = null, severity = 'info') {
    return { id, title, detail, category, severity, evidence, proposedAction, requiresPreview: proposedAction !== null, canApply: false };
}
function runLocalStudioAssistant(request, now = new Date()) {

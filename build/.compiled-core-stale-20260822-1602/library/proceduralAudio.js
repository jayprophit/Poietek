...
exports.renderProceduralSample = renderProceduralSample;
exports.renderFoundryOneShotKit = renderFoundryOneShotKit;
...
function renderOneShot(id, sampleRate) {
...
function renderProceduralSample(id, sampleRate = 48000) {
...
function renderFoundryOneShotKit(sampleRate = 48000) {
    return ["foundry-kick", "foundry-snare", "foundry-hat", "foundry-clap", "foundry-tone"].map((id) => renderProceduralSample(id, sampleRate));
}

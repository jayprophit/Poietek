...
exports.createLocalCreativeOsFoundation = createLocalCreativeOsFoundation;
exports.indexCanonicalAsset = indexCanonicalAsset;
const contracts_1 = require("./contracts");
function createLocalCreativeOsFoundation(options) {
    const now = options.now ?? new Date().toISOString();
    return {
        schemaVersion: contracts_1.CREATIVE_OS_SCHEMA_VERSION,
...
function indexCanonicalAsset(foundation, asset, now = new Date().toISOString()) {

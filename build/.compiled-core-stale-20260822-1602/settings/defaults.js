...
exports.cloneStudioPreferences = cloneStudioPreferences;
exports.createBalancedStudioPreferences = createBalancedStudioPreferences;
exports.createBuiltInStudioProfiles = createBuiltInStudioProfiles;
exports.createDefaultStudioSettingsDocument = createDefaultStudioSettingsDocument;
const contracts_1 = require("./contracts");
const DEFAULT_TIMESTAMP = "2026-01-01T00:00:00.000Z";
function cloneStudioPreferences(preferences) {
    return JSON.parse(JSON.stringify(preferences));
}
function createBalancedStudioPreferences() {
    return {
        audio: {
            inputDeviceId: null,
            outputDeviceId: null,
...
function builtInProfile(id, name, description, configure) {
...
function createBuiltInStudioProfiles() {
    return [
...
function createDefaultStudioSettingsDocument(now = new Date()) {
    const profiles = createBuiltInStudioProfiles();
    return {
        schemaVersion: contracts_1.STUDIO_SETTINGS_SCHEMA_VERSION,

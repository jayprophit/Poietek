...
exports.DEVELOPMENT_LIBRARY_APPENDICES = exports.DEVELOPMENT_LIBRARY_PARTS = exports.DEVELOPMENT_LIBRARY_VOLUMES = exports.DEVELOPMENT_LIBRARY_SOURCE = void 0;
exports.searchDevelopmentLibrary = searchDevelopmentLibrary;
exports.validateDevelopmentLibraryDomainLinks = validateDevelopmentLibraryDomainLinks;
exports.DEVELOPMENT_LIBRARY_SOURCE = {
...
exports.DEVELOPMENT_LIBRARY_VOLUMES = [
    {
...
exports.DEVELOPMENT_LIBRARY_PARTS = [
...
exports.DEVELOPMENT_LIBRARY_APPENDICES = [
...
function searchDevelopmentLibrary(query) {
    const normalized = query.trim().toLocaleLowerCase();
    if (!normalized)
        return [...exports.DEVELOPMENT_LIBRARY_VOLUMES];
    return exports.DEVELOPMENT_LIBRARY_VOLUMES.filter((volume) => [
...
function validateDevelopmentLibraryDomainLinks(validDomainIds) {
    const missing = [...new Set(exports.DEVELOPMENT_LIBRARY_VOLUMES.flatMap((volume) => volume.domainIds.filter((id) => !validDomainIds.has(id))))];

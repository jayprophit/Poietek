...
const STORE_ITEMS: ShopItem[] = [
  ...
  {
    id: 'grain_synth',
    name: 'Grain Sample Manipulator',
    category: 'synth',
    description: 'Granular synthesis engine that slices audio samples into micro-grains with real-time formant modulation.',
    priceType: 'included_pass',
    rating: 4.9,
    downloads: '84k',
    badge: 'GRANULAR ENGINE',
    iconBg: 'from-amber-500 to-yellow-800',
    tags: ['Granular', 'Sample Slicer', 'Formant'],
    moduleTypeToAdd: 'grain_synth',
  },
  {
    id: 'radical_piano',
    name: 'Radical Piano Acoustic Modeling',
    category: 'synth',
    description: 'Physical modeling grand piano combined with sampling for ultra-authentic concert piano dynamics.',
    priceType: 'included_pass',
    rating: 5.0,
    downloads: '105k',
    badge: 'CONCERT GRAND',
    iconBg: 'from-stone-700 to-neutral-900',
    tags: ['Physical Modeling', 'Grand Piano', 'Acoustic'],
    moduleTypeToAdd: 'polytone_synth',
  },
  {
    id: 'master_maximizer',
    name: 'Master Maximizer & Brickwall Limiter',
    category: 'fx',
    description: 'Zero-latency brickwall mastering limiter with lookahead peak suppression and loudness metering.',
    priceType: 'included_pass',
    rating: 4.9,
    downloads: '128k',
    badge: 'MASTERING GRADE',
    iconBg: 'from-indigo-600 to-slate-900',
    tags: ['Mastering', 'Limiter', 'Loudness'],
    moduleTypeToAdd: 'pulverizer_comp',
  },
  {
    id: 'tube_overdrive',
    name: 'Tube Drive & Tape Saturator FX',
    category: 'fx',
    description: 'Warm analog 12AX7 tube harmonics, tape hiss, and subtle odd-harmonic distortion.',
    priceType: 'free',
    rating: 4.8,
    downloads: '160k',
    badge: 'FREE EFFECT',
    iconBg: 'from-orange-600 to-red-950',
    tags: ['Tube Warmth', 'Analog Tape', 'Overdrive'],
    moduleTypeToAdd: 'scream4_distortion',
  },
  {
    id: 'sample_pack_drill',
    name: 'UK/NY Drill & Trap Sliding 808s',
    category: 'samples',
    description: 'Sliding sub-bass 808s, snappy snares, hi-hat rolls, and accent percussion FX.',
    priceType: 'free',
    rating: 4.9,
    downloads: '290k',
    badge: 'FREE SAMPLE PACK',
    iconBg: 'from-blue-600 to-indigo-900',
    tags: ['Drill 808', 'Trap Drums', 'Sub Bass'],
  },
  {
    id: 'sample_pack_soul',
    name: 'Neo-Soul Rhodes & Electric Keys',
    category: 'samples',
    description: 'Vintage 1973 Mark I Electric Piano chords, vinyl noise loops, and jazz licks.',
    priceType: 'included_pass',
    rating: 4.9,
    downloads: '140k',
    badge: 'R&B CLASSIC',
    iconBg: 'from-purple-600 to-pink-900',
    tags: ['Rhodes Keys', 'Neo-Soul', 'Electric Piano'],
  },
  {
    id: 'skin_mahogany',
    name: 'Mahogany Wood & Brass Custom Rack Skin',
    category: 'skins',
    description: 'Rich dark mahogany side cheeks, polished brass knobs, and vintage VU meter glass.',
    priceType: 'included_pass',
    rating: 5.0,
    downloads: '180k',
    badge: 'PREMIUM LUXURY SKIN',
    iconBg: 'from-amber-900 to-stone-900',
    tags: ['Mahogany Wood', 'Brass Hardware', 'VU Meter'],
  },
  {

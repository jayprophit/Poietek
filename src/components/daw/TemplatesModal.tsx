...
export const TemplatesModal: React.FC<TemplatesModalProps> = ({
  ...
  const builtinTemplates: StudioTemplate[] = [
    ...
    },
    {
      ...
      description: 'Pre-stacked with MPC Studio Drum Pad, SP-404 MFX Sampler, Chop Lab Stem Slicer, and Tape Compression.',
      category: 'genre',
      bpm: 86,
      modules: [
        { id: 'hip_mpc', type: 'mpc', title: 'MPC Studio Drum Pad', tapeLabel: 'LO-FI CHOP' },
        { id: 'hip_chop', type: 'chop_lab', title: 'Chop Lab Stem Slicer', tapeLabel: 'SAMPLE SLICER' },
        { id: 'hip_sp404', type: 'sp404', title: 'SP-404 MKII Sampler', tapeLabel: 'VINYL WARMTH' },
        { id: 'hip_mixer', type: 'mixer', title: 'SSL Master Mixer', tapeLabel: 'ANALOG TAPE' },
      ],
    },
    {
      id: 'synthwave_rig',
      name: 'Synthwave & Cyberpunk Stack',
      description: 'Pre-stacked with Analog Subtractive Synth, Pattern Step Channel Rack, Universal Piano Roll, and SSL Master Console.',
      category: 'genre',
      bpm: 118,
      modules: [
        ...
        { id: 'sw_mixer', type: 'mixer', title: 'SSL Master Mixer', tapeLabel: 'RETRO DRIVE' },
      ],
    },
    {
      id: 'vocal_suite',
      name: 'Vocal Production Suite',
      description: 'Pre-stacked with Pro Vocal Pitch Tuner, Multi-Track Waveform Sequencer, Reverb Echo Bus, and SSL Master Console.',
      category: 'genre',
      bpm: 100,
      modules: [
        { id: 'voc_pitch', type: 'melodyne_pitch', title: 'Pro Vocal Pitch Editor', tapeLabel: 'SCALE LOCK' },
        { id: 'voc_seq', type: 'wave_sequencer', title: 'Multi-Track Audio Sequencer', tapeLabel: 'LEAD VOCALS' },
        { id: 'voc_mixer', type: 'mixer', title: 'SSL Master Mixer', tapeLabel: 'VOCAL BUS' },
      ],
    },
  ];

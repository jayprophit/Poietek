import type {AiProviderDefinition, AiProviderKind} from './contracts';
...
export function getAiProviderDefinition(id: AiProviderKind): AiProviderDefinition {
  const definition = AI_PROVIDER_CATALOG.find((candidate) => candidate.id === id);

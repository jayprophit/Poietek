      ...
      <div className="flex min-h-0 flex-1">
        ...
        <main className="min-w-0 flex-1 overflow-y-auto p-4 text-stone-200">
          ...
          {activeTab === 'audio' && <section className="space-y-4">
            <div><h3 className="text-base font-black text-white">Audio engine and devices</h3><p className="text-xs text-stone-400">Browser controls are requested policies. Only enumerated endpoints and reported context values are shown as detected.</p></div>
            <Notice title="Capability boundary">Web builds cannot select ASIO/Core Audio drivers, force hardware buffers, or prove round-trip latency. The native adapter must negotiate those settings with the installed driver.</Notice>

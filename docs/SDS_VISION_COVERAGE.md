...
| AI creative assistant | Foundation built | Optional provider router, deterministic local analysis, preview/accept/undo rules and Creative Intent Lock classification | Configured/local models, cross-modal analysis, reference licensing, consent and explainability UI |
